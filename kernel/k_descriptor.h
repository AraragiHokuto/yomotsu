...
struct gdt_code_desc_s {
        u64 ign_1 : 42, c : 1, mb3 : 2, dpl : 2, p : 1, ign_2 : 5, l : 1, d : 1,
            ign_3 : 9;
} PACKED;
...
struct gdt_data_desc_s {
        u64 ign_1 : 41, w : 1, e : 1, mbz : 1, mb1 : 1, dpl : 2, p : 1,
            ign_2 : 16;
} PACKED;
...
struct gdt_tss_selector_s {
        u64 limit_l : 16, base_l1 : 24, type : 4, mbz_1 : 1, dpl : 2, p : 1,
            limit_h : 4, avl : 1, ign_1 : 2, g : 1, base_l2 : 8;
        u32 base_h;
        u32 mbz_2;
} PACKED;
