...
#define __ATOMIC_INC_FETCH_IMPL(dst, order) __atomic_add_fetch(&dst, 1, order)
#define __ATOMIC_DEC_FETCH_IMPL(dst, order) __atomic_sub_fetch(&dst, 1, order)
#define __ATOMIC_FETCH_INC_IMPL(dst, order) __atomic_fetch_add(&dst, 1, order)
#define __ATOMIC_FETCH_DEC_IMPL(dst, order) __atomic_fetch_dec(&dst, 1, order)
#define __ATOMIC_CMPXCHG_WEAK_IMPL(                      \
    dst, expected, desired, order_success, order_failed) \
        __atomic_compare_exchange_n(                     \
            &dst, &expected, desired, B_TRUE, order_success, order_failed)
#define __ATOMIC_CMPXCHG_STRONG_IMPL(                    \
    dst, expected, desired, order_success, order_failed) \
        __atomic_compare_exchange_n(                     \
            &dst, &expected, desired, B_FALSE, order_success, order_failed)

#define atomic_load_sint(dst, order)       __ATOMIC_LOAD_IMPL(val, order)
#define atomic_store_sint(dst, val, order) __ATOMIC_STORE_IMPL(dst, val, order)
#define atomic_xchg_sint(dst, val, order)  __ATOMIC_XCHG_IMPL(dst, val, order)
...
#define atomic_inc_fetch_sint(dst, order) __ATOMIC_INC_FETCH_IMPL(dst, order)
#define atomic_dec_fetch_sint(dst, order) __ATOMIC_DEC_FETCH_IMPL(dst, order)
#define atomic_fetch_inc_sint(dst, order) __ATOMIC_FETCH_INC_IMPL(dst, order)
#define atomic_fetch_dec_sint(dst, order) __ATOMIC_FETCH_DEC_IMPL(dst, order)
...
#define atomic_store_uint(dst, val, order) __ATOMIC_STORE_IMPL(dst, val, order)
#define atomic_xchg_uint(dst, val, order)  __ATOMIC_XCHG_IMPL(dst, val, order)
...
#define atomic_fetch_sub_uint(dst, val, order) \
        __ATOMIC_FETCH_SUB_IMPL(dst, val, order)
#define atomic_inc_fetch_uint(dst, order) __ATOMIC_INC_FETCH_IMPL(dst, order)
#define atomic_dec_fetch_uint(dst, order) __ATOMIC_DEC_FETCH_IMPL(dst, order)
#define atomic_fetch_inc_uint(dst, order) __ATOMIC_FETCH_INC_IMPL(dst, order)
#define atomic_fetch_dec_uint(dst, order) __ATOMIC_FETCH_DEC_IMPL(dst, order)
...
#define atomic_xchg_boolean(dst, val, order) __ATOMIC_XCHG_IMPL(dst, val, order)
...
#define atomic_store_u8(dst, val, order) __ATOMIC_STORE_IMPL(dst, val, order)
#define atomic_xchg_u8(dst, val, order)  __ATOMIC_XCHG_UINT(dst, val, order)
...
#define atomic_fetch_sub_u8(dst, val, order) \
        __ATOMIC_FETCH_SUB_IMPL(dst, val, order)
#define atomic_inc_fetch_u8(dst, order) __ATOMIC_INC_FETCH_IMPL(dst, order)
#define atomic_dec_fetch_u8(dst, order) __ATOMIC_DEC_FETCH_IMPL(dst, order)
#define atomic_fetch_inc_u8(dst, order) __ATOMIC_FETCH_INC_IMPL(dst, order)
#define atomic_fetch_dec_u8(dst, order) __ATOMIC_FETCH_DEC_IMPL(dst, order)
...
#define atomic_store_u64(dst, val, order) __ATOMIC_STORE_IMPL(dst, val, order)
#define atomic_xchg_u64(dst, val, order)  __ATOMIC_XCHG_UINT(dst, val, order)
...
#define atomic_fetch_sub_u64(dst, val, order) \
        __ATOMIC_FETCH_SUB_IMPL(dst, val, order)
#define atomic_inc_fetch_u64(dst, order) __ATOMIC_INC_FETCH_IMPL(dst, order)
#define atomic_dec_fetch_u64(dst, order) __ATOMIC_DEC_FETCH_IMPL(dst, order)
#define atomic_fetch_inc_u64(dst, order) __ATOMIC_FETCH_INC_IMPL(dst, order)
#define atomic_fetch_dec_u64(dst, order) __ATOMIC_FETCH_DEC_IMPL(dst, order)
...
#define atomic_store_ptr(dst, val, order) __ATOMIC_STORE_IMPL(dst, val, order)
#define atomic_xchg_ptr(dst, val, order)  __ATOMIC_XCHG_IMPL(dst, val, order)
