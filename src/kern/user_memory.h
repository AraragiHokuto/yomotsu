#ifndef IZANAMI_USER_MEMORY_H__
#define IZANAMI_USER_MEMORY_H__
...
boolean	user_memory_read(address_space_t *as, void *dst,
	void *src, size_t size);
boolean	user_memory_write(address_space_t *as, void *dst,
	void *src, size_t size);
