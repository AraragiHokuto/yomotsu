...
#define __ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)		\
	__atomic_compare_exchange_n(&dst, &expected, desired, B_TRUE,	\
				    order_success, order_failed)
#define __ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)	\
	__atomic_compare_exchange_n(&dst, &expected, desired, B_FALSE,	\
				    order_success, order_failed)
...
#define atomic_cmpxchg_weak_sint(dst, expected, desired,		\
				 order_success, order_failed)		\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_sint(dst, expected, desired,		\
				   order_success, order_failed)		\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
...
#define atomic_fetch_dec_uint(dst, order)				\
	__ATOMIC_FETCH_DEC_IMPL(dst, order)
#define atomic_cmpxchg_weak_uint(dst, expected, desired,		\
				 order_success, order_failed)		\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_uint(dst, expected, desired,		\
				   order_success, order_failed)		\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
...
#define atomic_xchg_boolean(dst, val, order)	\
	__ATOMIC_XCHG_IMPL(dst, val, order)
#define atomic_cmpxchg_weak_boolean(dst, expected, desired,		\
				    order_success, order_failed)	\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_boolean(dst, expected, desired,		\
				      order_success, order_failed)	\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
...
#define atomic_fetch_dec_u8(dst, order)		\
	__ATOMIC_FETCH_DEC_IMPL(dst, order)
#define atomic_cmpxchg_weak_u8(dst, expected, desired,			\
			       order_success, order_failed)		\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_u8(dst, expected, desired,		\
				 order_success, order_failed)		\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
...
#define atomic_fetch_dec_u64(dst, order)	\
	__ATOMIC_FETCH_DEC_IMPL(dst, order)
#define atomic_cmpxchg_weak_u64(dst, expected, desired,		\
				order_success, order_failed)	\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,	\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_u64(dst, expected, desired,		\
				  order_success, order_failed)		\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
...
#define atomic_xchg_ptr(dst, val, order)	\
	__ATOMIC_XCHG_IMPL(dst, val, order)
#define atomic_cmpxchg_weak_ptr(dst, expected, desired,		\
				 order_success, order_failed)		\
	__ATOMIC_CMPXCHG_WEAK_IMPL(dst, expected, desired,		\
				   order_success, order_failed)
#define atomic_cmpxchg_strong_ptr(dst, expected, desired,		\
				   order_success, order_failed)		\
	__ATOMIC_CMPXCHG_STRONG_IMPL(dst, expected, desired,		\
				     order_success, order_failed)
